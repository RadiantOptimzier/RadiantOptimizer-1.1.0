...
function downloadOptimizer() {
    ...
    button.innerHTML = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="8 12 12 16 16 12"></polyline><line x1="12" y1="8" x2="12" y2="16"></line></svg> Downloading...';
    button.disabled = true;
    
    // Create invisible link and trigger download
    const link = document.createElement('a');
    link.href = downloadUrl;
    link.download = 'RadiantOptimizer-Setup.exe';
    ...
    setTimeout(() => {
        ...
        showCustomModal('Download started! Check your downloads folder.', 'Success');
    }, 2000);
}

// Make function globally available
window.downloadOptimizer = downloadOptimizer;
