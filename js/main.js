...
if (canvas) {
    ...
    class Particle {
        constructor() {
            ...
            this.size = Math.random() * 2.5 + 1.5; // Varied star sizes: 1.5-4px
            this.opacity = Math.random() * 0.6 + 0.4; // Random opacity for depth: 0.4-1.0
        ...
        draw() {
            ...
            // Center star - dark blue
            ctx.beginPath();
            ctx.arc(this.x, this.y, this.size, 0, Math.PI * 2);
            ctx.fillStyle = '#003d99'; // Dark blue
            ctx.fill();
    ...
    // No connections for stars - they exist independently
